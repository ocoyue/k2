...
###### Trading System 001 business architecture

ld the Architecture for business。建立业务全景

###### Trading System 002 tcp raw + session gateway

TCP RAW base. Gateway , split layer.
...
### Trading-sys-010-snapshot-creation-acceptance

### Trading-sys-011-async-tcp-foundation
